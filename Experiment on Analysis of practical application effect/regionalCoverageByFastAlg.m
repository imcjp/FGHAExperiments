function [ z ] = regionalCoverageByFastAlg( P,eta,rm,q,N,p,lamda0 )
    eps=1e-6;
    ...
    for i=1:length(r0s)
        for j=1:length(d1s)
            ...
            if d1>rm+r0
                ...
                z(i+j-1)=proOfBaseStation(P,r0,d1,rm,lamda0)*connProByFastAlg(P,r0,d1,eta,rm,q,N,p,lamda0)*pdfOf2D(r0,rm)*lamda0.*r0;
            end
        end
    end
end
